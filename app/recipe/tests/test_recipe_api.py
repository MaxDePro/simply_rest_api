...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_tags(self):
        ...
        tag1 = sample_tag(user=self.user, name='vegan_tag')
        tag2 = sample_tag(user=self.user, name='dessert_tag')
        payload = {
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Fish')
        tag1 = sample_tag(user=self.user, name='Vegan')
        tag2 = sample_tag(user=self.user, name='Meater')
    ...
    def test_filter_recipe_by_ingredients(self):
        """Test filtering with specific ingredients"""
        recipe1 = sample_recipe(user=self.user, title='Beans')
        recipe2 = sample_recipe(user=self.user, title='Duck')
        ingredient1 = sample_ingredient(user=self.user, name='Beans')
        ingredient2 = sample_ingredient(user=self.user, name='Apples')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(user=self.user, title='Mushrooms')
